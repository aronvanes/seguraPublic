...
<p>We hebben een nieuwe aanvraag binnen gekregen voor een optreden. Hieronder vind je de gegevens:</p>
<br>
...
<p><strong>Soort:</strong> {{$performance->type}}</p>
<p><strong>Betaald/onbetaald:</strong> {{$performance->paid}}</p>
<p><strong>Deadline:</strong> {{$performance->getDeadline}}</p>
